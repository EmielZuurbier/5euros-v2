...
let webpackConfig = {
  ...
  resolve: {
    ...
    alias: {
      '@api': path.resolve(config.paths.assets, 'scripts/api/'),
      '@audio': path.resolve(config.paths.assets, 'scripts/audio/'),
      '@autoload': path.resolve(config.paths.assets, 'scripts/autoload/'),
      '@data': path.resolve(config.paths.assets, 'scripts/data/'),
      '@fonts': path.resolve(config.paths.assets, 'scripts/fonts/'),
      '@routes': path.resolve(config.paths.assets, 'scripts/routes/'),
      '@util': path.resolve(config.paths.assets, 'scripts/util/'),
      '@view': path.resolve(config.paths.assets, 'scripts/view/'),
      '@web-components': path.resolve(
        config.paths.assets,
        'scripts/web-components/'
      ),
      '@workers': path.resolve(config.paths.assets, 'scripts/workers/')
    }
  },
  resolveLoader: {
